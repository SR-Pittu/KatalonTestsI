...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_LinkedIn Login, Sign in  LinkedIn/input_Sign in_session_password'),'n6OQ8FXXxv/gWLCA28/V+Q==')

WebUI.click(findTestObject('Object Repository/Page_LinkedIn Login, Sign in  LinkedIn/button_Sign in'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_(3) Feed  LinkedIn/span_LinkedIn News'),'LinkedIn News')