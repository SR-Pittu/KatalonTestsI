...
if (email != 'janet.weaver@reqres.in'&&parsedJson.get('data')['first_name'] != 'Janet'&&parsedJson.get('data')['last_name'] != 'Weaver') {
	
	KeywordUtil.markFailed('email and full name are not matching')
