...
if (email != 'janet.weaver@reqres.in') {
	
    KeywordUtil.markFailed('email is not matching')
	
} else if (parsedJson.get('data')['first_name'] != 'Janet') {
	
    KeywordUtil.markFailed('first_name is not matching')
	
} else if (parsedJson.get('data')['last_name'] != 'Weaver') {
	
	KeywordUtil.markFailed('Last_name is not matching')
	
} else if (parsedJson.get('data')['id'] != 2) {
	
    KeywordUtil.markFailed('id is not matching')
