...
WebUI.setText(findTestObject('Object Repository/Page_Register as a Creator/input_Email_email'),'psreddy102@gmail.com')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Register as a Creator/error'), 'Email already exists')